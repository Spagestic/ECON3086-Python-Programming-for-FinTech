...
def portfolio_optimization(tickers, train_period, test_period, max_weight=0.20, risk_free_rate=0.03):
    ...
    data = yf.download(tickers, start=train_period[0], end=test_period[1])['Close']
...
tickers = [
    ...
    'UNH', 'PFE', 'NKE', 'T', 'VZ', 'JPM', 'WMT', 'HD',
    'DIS', 'CMCSA', 'BAC', 'INTC', 'CSCO', 'PEP', 'XOM',
    'CVX', 'MRK', 'WFC', 'BA', 'C', 'ORCL', 'IBM', 'PM',
    'MCD', 'ABBV', 'MMM', 'GE', 'HON', 'AMT', 'SPG', 'LIN',
    'UPS', 'CAT', 'LMT', 'RTX', 'LOW', 'AMD', 'BKNG', 'ZM',
    'PYPL', 'NFLX', 'CRM', 'UBER', 'LYFT', 'SNAP',
]

train_period = ("2024-01-01", "2024-06-30")
test_period = ("2024-07-01", "2024-12-31")

results = portfolio_optimization(tickers, train_period, test_period, max_weight=0.05)
